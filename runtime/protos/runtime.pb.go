...
type ActivateComponentRequest struct {
	...
	Requester string `protobuf:"bytes,3,opt,name=requester,proto3" json:"requester,omitempty"` // Unique weavelet id of requesting weavelet
...
func (x *ActivateComponentRequest) GetRequester() string {
	if x != nil {
		return x.Requester
	}
	return ""
...
var file_runtime_protos_runtime_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x6e, 0x0a, 0x18, 0x41, 0x63,
	...
	0x73, 0x74, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
