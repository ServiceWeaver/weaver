...
func initMultiProcess(ctx context.Context, t testing.TB, isBench bool, runner Runner, locals []reflect.Type, logWriter func(*protos.LogEntry)) (context.Context, func() error, error) {
	t.Helper()
