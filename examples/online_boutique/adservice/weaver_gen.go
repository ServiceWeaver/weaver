...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/weaver/examples/online_boutique/adservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getAdsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/adservice/T", Method: "GetAds"})}
		},
...
func (s t_client_stub) GetAds(ctx context.Context, a0 []string) (r0 []Ad, err error) {
	...
	r0 = serviceweaver_dec_slice_Ad_e7e16348(dec)
	err = dec.Error()
	return
}
...
func (s t_server_stub) getAds(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	serviceweaver_enc_slice_Ad_e7e16348(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func serviceweaver_enc_slice_Ad_e7e16348(enc *codegen.Encoder, arg []Ad) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_Ad_e7e16348(dec *codegen.Decoder) []Ad {
	n := dec.Len()
	if n == -1 {
		return nil
	}
