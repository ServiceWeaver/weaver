...
func (x *Order) WeaverMarshal(enc *codegen.Encoder) {
	...
	serviceweaver_enc_slice_OrderItem_c76e2869(enc, x.Items)
}
...
func (x *Order) WeaverUnmarshal(dec *codegen.Decoder) {
	...
	x.Items = serviceweaver_dec_slice_OrderItem_c76e2869(dec)
}

func serviceweaver_enc_slice_OrderItem_c76e2869(enc *codegen.Encoder, arg []OrderItem) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_OrderItem_c76e2869(dec *codegen.Decoder) []OrderItem {
	n := dec.Len()
	if n == -1 {
		return nil
	}
