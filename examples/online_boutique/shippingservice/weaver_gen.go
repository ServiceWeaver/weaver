...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/weaver/examples/online_boutique/shippingservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getQuoteMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/shippingservice/T", Method: "GetQuote"}), shipOrderMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/shippingservice/T", Method: "ShipOrder"})}
		},
...
func serviceweaver_enc_slice_CartItem_b804d0c3(enc *codegen.Encoder, arg []cartservice.CartItem) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_CartItem_b804d0c3(dec *codegen.Decoder) []cartservice.CartItem {
	n := dec.Len()
	if n == -1 {
		return nil
	}
