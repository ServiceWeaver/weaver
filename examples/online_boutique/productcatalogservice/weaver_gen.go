...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/weaver/examples/online_boutique/productcatalogservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, listProductsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/productcatalogservice/T", Method: "ListProducts"}), getProductMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/productcatalogservice/T", Method: "GetProduct"}), searchProductsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver/examples/online_boutique/productcatalogservice/T", Method: "SearchProducts"})}
		},
...
func (s t_client_stub) ListProducts(ctx context.Context) (r0 []Product, err error) {
	...
	r0 = serviceweaver_dec_slice_Product_244e861c(dec)
	err = dec.Error()
	return
}
...
func (s t_server_stub) listProducts(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	serviceweaver_enc_slice_Product_244e861c(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func serviceweaver_enc_slice_Product_244e861c(enc *codegen.Encoder, arg []Product) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_Product_244e861c(dec *codegen.Decoder) []Product {
	n := dec.Len()
	if n == -1 {
		return nil
	}
